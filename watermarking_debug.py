...
def watermark(dcfile):
            ...
            if(index<len(bitwatermark) and bitwatermark[index]== 1 ):
                if (DC00 < A + P):
                    ...
                    if (abs(DC00 - new_DC0) <= 3):
                        print("Bit imp: 1" + ", nuovo DC00:" + str(math.floor(new_DC0)) + ", DC1-2-3: "+ str(math.floor(DC11)) + " " + str(math.floor(DC22)) + " " + str(math.floor(DC33)) +", Media = " + str(math.floor(A)) + ", blocco " + str([index_rows,i]))
                ...
                if (DC00 > A - P):
                    new_DC0 = A - P
                    if (abs(DC00 - new_DC0) <= 3):
                        print("Bit imp: 0" + ", nuovo DC00:" + str(math.floor(new_DC0)) + ", DC1-2-3: "+ str(math.floor(DC11)) + " " + str(math.floor(DC22)) + " " + str(math.floor(DC33)) +", Media = " + str(math.floor(A)) + ", blocco " + str([index_rows,i]))
                        DC0[i] = int(round(new_DC0, 1))
                        modified_blocks.append([index_rows,i])
                        index += 1
                else:
    ...
    print("Bit ottenuti del watermark: " + str(bitdewatermark))
